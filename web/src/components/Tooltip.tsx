...
function Tooltip({
  ...
  const positionOuterClasses = (position: string): string => {
    switch (position) {
      case 'right':
  ...
  const sizeClasses = (size: string): string => {
    switch (size) {
      case 'lg':
  ...
  const colorClasses = (bg: string): string => {
    switch (bg) {
      case 'light':
  ...
  const positionInnerClasses = (position: string): string => {
    switch (position) {
      case 'right':
        return 'ml-2';
      case 'left':
